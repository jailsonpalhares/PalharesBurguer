...
def atualizar_burguer(burguer_id):
    try:
        ...
        # Executar uma consulta SQL para atualizar os dados do burguer com base no burguer_id
        cursor.execute('''
            UPDATE burguers
...
def dashboard():
    if 'usuario_id' in session:
        ...
        # Buscar os burguers do banco de dados (ou de outra fonte)
...
def list_burguers():
    ...
    # Recupere todos os burguers do banco de dados
...
def obter_pedidos_realizados():
    try:
        ...
        # Consulta SQL para obter os pedidos já realizados e os burguers relacionados
        cursor.execute('''
            SELECT 
        ...
        for pedido_data in pedidos_data:
            ...
            # Crie um registro para o item de pedido e burguers relacionados
            item_pedido = {
